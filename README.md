### This is a FORK aimed an optimizing installion for specific usecases and hardware. Will miss bits and pieces and fall behind original repo. Use the original repo instead
