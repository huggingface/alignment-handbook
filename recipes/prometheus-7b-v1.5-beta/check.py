...
def decode_labels_with_ignore_index(labels, tokenizer, ignore_index=-100):
    ...
    for label_ids in labels:
        ...
        valid_label_ids = [token_id for token_id in label_ids if token_id != ignore_index]
...
decoded_labels = decode_labels_with_ignore_index(loaded_labels, tokenizer, ignore_index=-100)
