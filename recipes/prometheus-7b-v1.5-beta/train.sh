...
CUDA_VISIBLE_DEVICES=0,1,3,7,8,9,10,11,14,15 ACCELERATE_LOG_LEVEL=info accelerate launch --config_file recipes/accelerate_configs/deepspeed_zero3.yaml --num_processes=10 scripts/run_sft.py recipes/prometheus-7b-v1.5-beta/sft/config_full_bgb.yaml
